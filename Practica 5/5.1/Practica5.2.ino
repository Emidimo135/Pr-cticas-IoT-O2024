...
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=20&lon=-103&appid=a7d9f4983672009cdc725bababacdd01&unids=metric"; //API KEY OpenWeather


// ThingSpeak
uint32_t channelNumber = 2720896;
const char *writeAPIKey = "FT7QWV0U6R9WN3XU";
...
void sendDataToThingSpeak(){
    ...
    int code = ThingSpeak.writeFields(2720896, "FT7QWV0U6R9WN3XU");
    if(code == 200)
...
// OpenWeather
String apiTemperature;
String serverPath = [https://api.openweathermap.org/data/2.5/weather?lat=20&lon=-103&appid=a7d9f4983672009cdc725bababacdd01&units=metrics];
